...
Use [`references/housekeeping.md`](references/housekeeping.md). Read dependencies before recommending retirement or deletion, and require explicit confirmation for every write.
