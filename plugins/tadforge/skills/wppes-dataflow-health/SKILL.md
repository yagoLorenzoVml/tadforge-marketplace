...
Use [`references/dataflow-health.md`](references/dataflow-health.md). Query current and historical evidence available through MCP and preserve the distinction between no records and unavailable telemetry.
