...
# AEP Identity and Profile

Use [`references/identity-profile.md`](references/identity-profile.md). Inspect live namespaces, descriptors, datasets, and merge policies before making account-specific claims.
