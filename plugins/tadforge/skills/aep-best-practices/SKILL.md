...
Apply [`references/best-practices.md`](references/best-practices.md) as the baseline. Verify live configuration with MCP before judging a specific IKEA resource, and cite concrete evidence for every finding.
